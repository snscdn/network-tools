# SNSCDN public tutorial navigator / 公开教程导航

[简体中文](#简体中文) · [English](#english)

## 简体中文

完整操作步骤维护在主站，以下教程无需登录即可阅读。按当前问题选择下一步：

- **第一次使用？** [从注册到首次连接](https://snscdn.com/zh-cn/docs/quick-start?utm_source=github&utm_medium=referral)：确认注册、订单开通与客户端导入的先后顺序。
...
- **已经运行 netcheck，但看不懂 PASS、FAIL 或 SKIP？** [网络检查结果逐行说明](https://snscdn.com/zh-cn/docs/network-check-results?utm_source=github&utm_medium=referral)：从最早异常层开始判断，并安全整理工单信息。
...
如需区分 DNS、TCP、TLS 或 HTTP 问题，可使用本仓库的[本地诊断工具](https://github.com/snscdn/network-tools/blob/main/README.zh-CN.md)。工具不上传诊断结果；脚本问题可提交 Issue，账户或订单问题请使用主站工单。

## English

The full instructions are maintained on the main website and can be read without signing in. Choose a guide based on where you are stuck:

- **Starting for the first time?** [Registration to first connection](https://snscdn.com/docs/quick-start?utm_source=github&utm_medium=referral) explains the order of registration, activation and client import.
...
- **Ran netcheck but unsure about PASS, FAIL, or SKIP?** [Read the result line by line](https://snscdn.com/docs/network-check-results?utm_source=github&utm_medium=referral), starting with the earliest abnormal layer and preparing a privacy-safe support summary.
...
To distinguish DNS, TCP, TLS and HTTP problems, try the repository's [local diagnostic tools](https://github.com/snscdn/network-tools/blob/main/README.md). They do not upload results. Use GitHub issues for script problems and the website's support tickets for account or order help.
